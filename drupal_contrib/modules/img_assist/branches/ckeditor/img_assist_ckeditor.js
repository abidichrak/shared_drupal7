 ...
 * This file is used instead of img_assist_ckeditor.js if img_assist is called
 * from the textarea button.
 * Additional JS files similar to img_assist_textarea.js and
 * img_assist_ckeditor.js could be created for using img_assist with other
...
function insertToEditor(content) {
  window.opener.ckeditor_setImageAssist(content, window);
