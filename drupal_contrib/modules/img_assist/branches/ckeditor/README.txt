...
* Using this module with CKEditor via CKEditor module:
  1. Click the image icon on the CKEditor toolbar.
...
* Adding images with Image module
  ...
  or icon (configurable). Access to img_assist via the CKEditor plugin is
  controlled by the CKEditor module.
